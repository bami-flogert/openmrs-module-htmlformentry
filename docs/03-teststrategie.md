...
- [x] CI quality-workflow groen op PR/push (PR #31, [run 27682116331](https://github.com/bami-flogert/openmrs-module-htmlformentry/actions/runs/27682116331))
- [x] `[04-testresultaten-baseline.md](04-testresultaten-baseline.md)` bijgewerkt
- [x] JaCoCo baseline + na PoC-tests gedocumenteerd
- [x] Regressie-subset (5 groene api-tests) gedocumenteerd
