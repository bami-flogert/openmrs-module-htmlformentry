...
| **A.8.15** Logging | CI/CD-workflow security (SAST) | zizmor — statische analyse van GitHub Actions + Dependabot | [`zizmor.md`](../zizmor.md) — lokaal `zizmor .`; baseline 2026-06-15: 43 high, 15 medium | ⚠️ Gedeeltelijk — lokaal/audit; nog geen CI-gate |
