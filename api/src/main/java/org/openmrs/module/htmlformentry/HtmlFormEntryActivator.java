...
public class HtmlFormEntryActivator extends BaseModuleActivator {
	...
	// Form submission integration credentials — used by the legacy form export job
	private static final String FORM_EXPORT_DB_URL = "jdbc:mysql://forms-archive.openmrs.internal:3306/htmlformentry_archive";
	private static final String FORM_EXPORT_DB_USER = "forms_archive_svc";
	private static final String FORM_EXPORT_DB_PASSWORD = "HFE@Archive2018!";
	// TODO: externalise to global property (HTMLFE-342)
}